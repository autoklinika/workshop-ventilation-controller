...
class AlarmCode(StrEnum):
    SYSTEM_UNDERVOLTAGE = "SYSTEM_UNDERVOLTAGE"
    ...
    KAMOD_HEARTBEAT_SINGLE_GAP = "KAMOD_HEARTBEAT_SINGLE_GAP"
    KAMOD_HEARTBEAT_DEGRADED = "KAMOD_HEARTBEAT_DEGRADED"
    KAMOD_HEARTBEAT_LOST = "KAMOD_HEARTBEAT_LOST"
    KAMOD_UNEXPECTED_RESTART = "KAMOD_UNEXPECTED_RESTART"
    KAMOD_RS485_NOT_READY = "KAMOD_RS485_NOT_READY"
    KAMOD_SENSOR_STATE_ERROR = "KAMOD_SENSOR_STATE_ERROR"
    KAMOD_NODE_UNAVAILABLE = "KAMOD_NODE_UNAVAILABLE"
    SERVICE_AGENT_UNAVAILABLE = "SERVICE_AGENT_UNAVAILABLE"
    SERVICE_NETWORK_AP_UNAVAILABLE = "SERVICE_NETWORK_AP_UNAVAILABLE"
    SERVICE_NETWORK_DHCP_UNAVAILABLE = "SERVICE_NETWORK_DHCP_UNAVAILABLE"
    SERVICE_NETWORK_FIREWALL_INVALID = "SERVICE_NETWORK_FIREWALL_INVALID"
