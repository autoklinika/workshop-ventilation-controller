...
const node=(b,a)=>b&&Array.isArray(b.nodes)?b.nodes.find(n=>n.slave_address===a)||null:null,ok=n=>!!(n&&n.online===true&&n.usable===true&&n.measurement_valid===true&&n.measurement_stale!==true),aok=a=>!!(a&&a.ready===true&&a.worker_alive===true&&a.online===true&&a.usable===true);
